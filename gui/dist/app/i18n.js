...
const ZH_EN = [
  ...
  ['不从经纬度猜地类。留空时它会作为明确的外部依赖显示；城市模式由向导固定为城市路径。', 'Land cover is not guessed from coordinates. If left blank it is shown as an external dependency; the wizard fixes urban mode to the urban path.'],
