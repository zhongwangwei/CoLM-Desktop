...
! ==== FIX 2026-08-16 #3 BEGIN: pft-level ozone stress coefficients were never
! restored from restart -> first step after restart used spval (-1e36) in
! gs0sun computation (LeafTemperaturePC line ~1200), causing run-dependent
! differences vs continuous runs. Read them with default 1.0. ====
...
! ==== FIX 2026-08-16 #3b: restart files regenerated by mkinidata (cold start) contain
! these variables with spval; sanitize them to 1.0 as well. ====
!      WHERE (o3coefv_sun_p <= -1.e30) o3coefv_sun_p = 1.0_r8
!      WHERE (o3coefv_sha_p <= -1.e30) o3coefv_sha_p = 1.0_r8
!      WHERE (o3coefg_sun_p <= -1.e30) o3coefg_sun_p = 1.0_r8
!      WHERE (o3coefg_sha_p <= -1.e30) o3coefg_sha_p = 1.0_r8
