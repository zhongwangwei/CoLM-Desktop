...
pub const SLOTS: [Slot; 8] = [
    Slot {
        ...
        candidates: &["Tair", "TA_F", "TA", "air_temperature", "temperature"],
        tintalgo: "linear",
        optional: false,
    },
    Slot {
    ...
    Slot {
        ...
        candidates: &["Precip", "Rainf", "P_F", "P", "precipitation", "rainfall"],
        tintalgo: "nearest",
        optional: false,
    },
    Slot {
    ...
    Slot {
        ...
        candidates: &["SWdown", "SW_IN_F", "SW_IN", "shortwave", "solar_radiation"],
        tintalgo: "linear",
        optional: false,
    },
    Slot {
