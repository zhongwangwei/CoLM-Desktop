...
pub use spatial::{
    ...
    build_catchment_spatial_topology_with_filter, build_coordinate_patch_selection,
    ...
    build_spatial_topology_with_filter_grid, gather_patch_raster, mesh_cell_area_weights,
